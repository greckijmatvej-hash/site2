...
class Blogarise_Section_Title extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Blogarise_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        ...
        <label>
            ...
            <select <?php $this->link(); ?>>
                <?php
                printf( '<option value="%s" %s>%s</option>', 0, selected( $this->value(), '', false ), esc_html( 'All', 'blogarise' )  );
                ?>
 ...
 * @see WP_Customize_Control
 */
class Blogarise_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Blogarise_Customize_Section_Upsell extends WP_Customize_Section {
...
/**
 * Class Blogarise_Customize_Heading_Control
 */
class Blogarise_Customize_Heading_Control extends WP_Customize_Control {
